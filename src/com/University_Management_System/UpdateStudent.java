    ...
    public void actionPerformed(ActionEvent ae){
        if(ae.getSource()==b){
            try{
                ...
                String str = "update student set name='"+t1.getText()+"',father_name='"+t2.getText()+"',age='"+t3.getText()+"', dob='"+t4.getText()+"',address='"+t5.getText()+"',phone='"+t6.getText()+"',email='"+t7.getText()+"',class_x='"+t8.getText()+"',class_xii='"+t9.getText()+"',aadhar='"+t10.getText()+"',branch='"+t14.getText()+"',course='"+t13.getText()+"' where rollno='"+t12.getText()+"'";

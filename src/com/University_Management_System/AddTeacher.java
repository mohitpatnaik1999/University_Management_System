...
class AddTeacher implements ActionListener{
    ...
    AddTeacher(){
        ...
        id15.setLayout(null);
        ImageIcon img = new ImageIcon(ClassLoader.getSystemResource("com/University_Management_System/icons/teacher.jpg"));
        ...
        String branch[] = {"CSE","ECE","EEE","ME","CE"};
    ...
    public void actionPerformed(ActionEvent ae){
        ...
        if(ae.getSource() == b){
            try{
                ...
                String q = "insert into teacher values('"+a+"','"+bb+"','"+c+"','"+d+"','"+e+"','"+ff+"','"+g+"','"+h+"','"+i+"','"+j+"','"+k+"','"+m+"','"+l+"')";

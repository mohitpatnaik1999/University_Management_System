...
public class AboutUs extends JFrame{
    ...
    public AboutUs() {
        ...
        ImageIcon i1  = new ImageIcon(ClassLoader.getSystemResource("com/University_Management_System/icons/logo.png"));
        ...
        JLabel l6 = new JLabel("Developed By : Mohit Patnaik");
        l6.setFont(new Font("Trebuchet MS", Font.BOLD, 30));
        l6.setBounds(70, 198, 600, 35);
        contentPane.add(l6);

        JLabel l7 = new JLabel("Contact Number: +918917629163");
        l7.setFont(new Font("Trebuchet MS", Font.BOLD, 20));
        l7.setBounds(70, 260, 600, 34);
        contentPane.add(l7);

        JLabel l8 = new JLabel("Contact : mohitpatnaik1999@gmail.com");
        ...
        JLabel l10 = new JLabel("Phone - +91 8917629163");
